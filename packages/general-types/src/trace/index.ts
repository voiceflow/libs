...
import { TraceFrame as TextTrace } from '@/nodes/text';
...
export { TraceFrame as TextTrace } from '@/nodes/text';
...
export type GeneralTrace = ExitTrace | SpeakTrace | ChoiceTrace | FlowTrace | StreamTrace | BlockTrace | DebugTrace | VisualTrace | TextTrace;
