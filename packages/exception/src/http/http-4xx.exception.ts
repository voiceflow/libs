...
export const ProxyAuthenticationRequiredException = createHTTPException(
...
export const RangeNotSatisfiableException = createHTTPException(
...
export const PreconditionRequiredException = createHTTPException(
...
export const UnavailableForLegalReasonsException = createHTTPException(
