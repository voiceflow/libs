...
export const isVoicePrompt = <Voice extends string = string>(prompt?: AnyPrompt | null): prompt is VoiceModels.Prompt<Voice> =>
  !!(prompt && 'content' in prompt && typeof prompt.content === 'string');

export const isIntentVoicePrompt = <Voice extends string = string>(prompt?: AnyPrompt | null): prompt is VoiceModels.IntentPrompt<Voice> =>
